...
func (t *T8424) SetFieldData(e *wrapper.EBestWrapper, resPath string, inBlocks ...interface{}) error {
...
func (t T8424) GetBlockData(e *wrapper.EBestWrapper, blockName string) string {
	return e.GetBlockData(blockName)
}

func (t *T8424) ReceivedData(e *wrapper.EBestWrapper, x wrapper.XaQueryReceiveData) {
...
func (t T8424) ReceivedMessage(e *wrapper.EBestWrapper, x wrapper.XaQueryReceiveMessage) {
	t.ReceiveMessageChan <- x
}

func (t T8424) ReceivedChartRealData(e *wrapper.EBestWrapper, x wrapper.XaQueryReceiveChartRealData) {
	t.ReceiveChartRealDataChan <- x
}

func (t T8424) ReceivedSearchRealData(e *wrapper.EBestWrapper, x wrapper.XaQueryReceiveSearchRealData) {
