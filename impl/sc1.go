...
func (s SC1) GetReceivedLinkDataChan() chan wrapper.XaRealReceiveLinkData {
	return s.ReceiveLinkDataChan
}

func (s *SC1) SetFieldData(e *wrapper.EBestWrapper, resPath string, inBlock interface{}) error {
...
func (s SC1) ReceivedLinkData(ew *wrapper.EBestWrapper, x wrapper.XaRealReceiveLinkData) {
