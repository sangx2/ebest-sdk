...
func (s SC4) GetReceivedRealDataChan() chan wrapper.XaRealReceiveRealData {
...
func (s SC4) GetOutBlock() interface{} {
	return s.OutBlock
}

func (s SC4) GetBlockData(e *wrapper.EBestWrapper, blockName string) string {
