...
func (h H1) GetReceivedRealDataChan() chan wrapper.XaRealReceiveRealData {
...
func (h H1) GetOutBlock() interface{} {
	return h.OutBlock
}

func (h H1) GetBlockData(e *wrapper.EBestWrapper, blockName string) string {
