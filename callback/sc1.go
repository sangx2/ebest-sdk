...
func (s SC1) GetReceivedRealDataChan() chan wrapper.XaRealReceiveRealData {
	return s.ReceiveRealDataChan
}

func (s SC1) GetReceivedLinkDataChan() chan wrapper.XaRealRecieveLinkData {
	return s.ReceiveLinkDataChan
}

func (s *SC1) SetFieldData(e *wrapper.Ebest, resPath string, inBlock interface{}) error {
	e.ResFileName(resPath + "SC1.res")

	return nil
}

func (s SC1) GetOutBlock() interface{} {
	return s.OutBlock
}

func (s *SC1) ReceivedRealData(e *wrapper.Ebest, x wrapper.XaRealReceiveRealData) {
...
func (s SC1) ReceivedLinkData(ew *wrapper.Ebest, x wrapper.XaRealRecieveLinkData) {
