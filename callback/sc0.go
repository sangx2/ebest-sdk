...
func (s SC0) GetReceivedLinkDataChan() chan wrapper.XaRealRecieveLinkData {
	return s.ReceiveLinkDataChan
}

func (s *SC0) SetFieldData(e *wrapper.Ebest, resPath string, inBlock interface{}) error {
...
func (s *SC0) ReceivedRealData(e *wrapper.Ebest, x wrapper.XaRealReceiveRealData) {
...
func (s SC0) ReceivedLinkData(ew *wrapper.Ebest, x wrapper.XaRealRecieveLinkData) {
